...
import com.dart.coderoom.model.Category;
...
public class CategoryEndpoint
{
   ...
   {
      TypedQuery<Category> findByIdQuery = em.createQuery("SELECT DISTINCT c FROM Category c LEFT JOIN FETCH c.courses WHERE c.id = :entityId ORDER BY c.id", Category.class);
   ...
   {
      TypedQuery<Category> findAllQuery = em.createQuery("SELECT DISTINCT c FROM Category c LEFT JOIN FETCH c.courses ORDER BY c.id", Category.class);
