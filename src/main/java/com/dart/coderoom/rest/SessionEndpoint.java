...
public class SessionEndpoint
{
   ...
   {
      TypedQuery<Session> findByIdQuery = em.createQuery("SELECT DISTINCT s FROM Session s LEFT JOIN FETCH s.course WHERE s.id = :entityId ORDER BY s.id", Session.class);
   ...
   {
      TypedQuery<Session> findAllQuery = em.createQuery("SELECT DISTINCT s FROM Session s LEFT JOIN FETCH s.course ORDER BY s.id", Session.class);
