...
import com.dart.coderoom.model.Task;
...
public class TaskEndpoint
{
   ...
   {
      TypedQuery<Task> findByIdQuery = em.createQuery("SELECT DISTINCT t FROM Task t LEFT JOIN FETCH t.followSession WHERE t.id = :entityId ORDER BY t.id", Task.class);
   ...
   {
      TypedQuery<Task> findAllQuery = em.createQuery("SELECT DISTINCT t FROM Task t LEFT JOIN FETCH t.followSession ORDER BY t.id", Task.class);
